...
# **카카오(035720)는 뺐다** (2026-09-23 지시 — 「카카오는 관심종목에서 제외」).
# 상위 50 을 보는데 **54위**라 어차피 신호가 안 났다. `market.js` 의
# `WATCHLIST` 와 같이 뺀다. **공시·뉴스에는 그대로 있다** — 빠뜨린 것이 아니다.
WATCH_FALLBACK = ["005930", "000660", "035420",
