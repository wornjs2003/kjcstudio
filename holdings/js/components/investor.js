/* ==========================================================================
   ...
   ── 두 값의 성격이 다르다 ──
     ...
     투자자        **마감 뒤에는 확정치**다 (docs/kis-sector-investor.md).
                    **장중에는 가집계다** — 아래 절을 따른다
     매수·매도 비율  체결이 아니라 **지금 걸려 있는 주문**이다.
                    장이 끝나면 뜻이 옅어진다 — 그래서 화면에 적는다

   **이 줄을 2026-09-22 에 고쳤다.** 장중 가집계를 붙이면서 아래 절만 쓰고
   여기는 「확정치다」 로 놔두었더니, **한 파일 안에서 두 말이 됐다**
   (`주식페이지_개발1` 지적). 새 절을 넣을 때 위 옛 문단도 같이 본다.
